...
class ldap_osx_test(unittest.TestCase):
    ...
    def test_01_Changing_permissions_on_SMB_PATH(self):
    ...
    def test_01_Creating_a_SMB_share_on_SMB_PATH(self):
    ...
    def test_01_Removing_SMB_share_on_SMB_PATH(self):
        payload = {"cfs_comment": "My Test SMB Share",
                   "cifs_path": SMB_PATH,
                   "cifs_name": SMB_NAME,
                   "cifs_guestok": True,
    ...
    def test_01_Stopping_SMB_service(self):
        assert PUT("/services/services/cifs/", {"srv_enable": False}) == 200

    def test_01_Verify_SMB_service_is_disabled(self):
        assert GET_OUTPUT("/services/services/cifs/", "srv_state") == "STOPPED"

    # Check destroying a SMB dataset
    def test_01_Destroying_SMB_dataset(self):
