...
RUN apt-get -y install build-essential debootstrap libjson-perl firefox-geckodriver git npm python3 python3-pip python3-venv samba smbclient sshpass squashfs-tools unzip
